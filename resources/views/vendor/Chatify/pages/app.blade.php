...
{{-- ----------------------Messaging side---------------------- --}}
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name">Agoratekton Messaging</a>
                </div>
                {{-- header buttons --}}
        ...
        {{-- Internet connection --}}
        <div class="internet-connection" style="margin-top: 17px;">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-envelope"></i> <span class="messenger-headTitle">messages</span> </a>
                {{-- header buttons --}}
                <nav class="m-header-right">
