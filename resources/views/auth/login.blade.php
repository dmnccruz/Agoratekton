...
<div id="loginFormsWrapper">
  <div id="loginWindow">
    ...
    <div id="loginIcon">
      <img width="30%" src="{{secure_asset('/images/icons/rhombus_200_transparent.gif')}}" alt="">
    </div>
    <div id="loginEmail">
...
<div id="registerFormsWrapper">
  <div id="successRegisterWindow">
    <img width="30%" src="{{secure_asset('/images/icons/handshake_200_transparent.gif')}}" alt="">
      ...
      <div id="registerWindow">
        ...
        <div id="registerPic">
          <div id="registerProfilePic">
            <img id="output"  style="z-index: 100;" width="100%" src="" alt="">
            <input type="file" id="profilePic" name="profilePic" onchange="loadFile(event)"/>
            <img id="profilePic2" width="15%" src="{{secure_asset('/images/icons/download_200_transparent.gif')}}" alt="">
          </div>
        </div>
        <div id="registerRole">
          <div id="roleRegular" onclick="regularUser(this)" class="roles roleActive magic-hover magic-hover__square" data-role="regular">Regular</div>
          <div id="roleArchitect" onclick="archUser(this)" class="roles magic-hover magic-hover__square" data-role="architect">Architect</div>
          <div id="roleSupplier" onclick="suppUser(this)" class="roles magic-hover magic-hover__square" data-role="supplier">Supplier</div>
        </div>
        <div id="registerName">
        ...
        <button onclick="registerNow()" id="registerButtonMain">Register</button>
      </div>
  <!-- </form> -->
</div>
...
<div id="wordsWrapper">
  <div id="wordsWrapper2">
    <img id="agora" width="50%" src="{{secure_asset('/images/agora.png')}}" alt="">
    <img id="agorameaning" width="100%" src="{{secure_asset('/images/agorameaning.png')}}" alt="">
    <img id="tekton" width="50%" src="{{secure_asset('/images/tekton.png')}}" alt="">
    <img id="tektonmeaning" width="100%" src="{{secure_asset('/images/tektonmeaning.png')}}" alt="">
  </div>
</div>
...
// }
  ...
  function init() {
    ...
    loader.load("{{secure_asset('/3d/scene.gltf')}}", function(gltf){
...
<div class="container" style="z-index=: -9999 !important; opacity: 0; position: absolute;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button id="laravelLoginButton" type="submit" class="btn btn-primary">
                                    {{ __('Login') }}
                                </button>
