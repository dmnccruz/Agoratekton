(function() {
	...
	var canvasParent = document.getElementById('doodle');
	...
	var channel = localStorage.getItem('meetingId');

	var pubnub = PUBNUB.init({
		publish_key     : 'pub-c-20d30828-fecd-43ea-80f6-d0bece24ad43',
		subscribe_key   : 'sub-c-4d714aa0-dcb0-11ea-8bd7-8a4c302968ae',
